...
public class TelaAvaliacaoAtualizada extends JFrame {
     ...
     * Create the frame.
     */
    public TelaAvaliacaoAtualizada() {
        ...
        lblNewLabel.setIcon(new ImageIcon(TelaAvaliacaoAtualizada.class.getResource("/visao/Icones/IconeRealizado.png")));
        Icone.add(lblNewLabel, "cell 0 0,alignx center,aligny bottom");

        JLabel lblNoRealizado = new JLabel("Avaliação Atualizada Com Sucesso!");
