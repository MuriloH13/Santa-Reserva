...
public class TelaCadastroRealizado extends JFrame {
    ...
    public TelaCadastroRealizado() {
        ...
        lblNewLabel.setIcon(new ImageIcon(TelaCadastroRealizado.class.getResource("/visao/Icones/IconeRealizado.png")));
        Icone.add(lblNewLabel, "cell 0 0,alignx center,aligny bottom");

        JLabel lblNoRealizado = new JLabel("Cadastro Realizado Com Sucesso!");
